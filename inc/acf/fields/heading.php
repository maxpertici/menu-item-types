...
if( function_exists('acf_add_local_field_group') ){
    ...
    acf_add_local_field_group(array(
        ...
        'key'      => $mip_custom_menu_item_spec['heading']['acf_group']['key'],
        'title'    => $mip_custom_menu_item_spec['heading']['acf_group']['title'],
        'fields'   => $mip_custom_menu_item_spec['heading']['acf_fields'],
